                ...
                <div className="p-6 mx-auto max-w-7xl lg:p-8">
                    ...
                    <div className="mt-16">
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:gap-8">
                            ...
                            >
                                <div>
                                    <div className="flex justify-center items-center w-16 h-16 bg-red-50 rounded-full dark:bg-red-800/20">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            fill="none"
                                            viewBox="0 0 24 24"
                                ...
                                <svg
                                    ...
                                    viewBox="0 0 24 24"
                                    strokeWidth="1.5"
                                    className="self-center mx-6 w-6 h-6 shrink-0 stroke-red-500"
                                >
                                    <path
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
