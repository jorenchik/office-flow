...
return [
    ...
    'attributes' => [
        ...
        'capacity' => 'ietilpība',
        'id' => 'Id',
        'registered_at' => 'Reģistrēts',
        'user_id' => 'Lietotāja id',
        'type_id' => 'Tipa id',
        'workplace_id' => 'Darbavietas id',
        'office_id' => 'Biroja id',
        'head_id' => 'Vadītāja id',
        'uuid' => 'Uuid',
        ...
        'mime_type' => 'Mime tips',
        'disk' => 'Disks',
        'conversions_disk' => 'Konversiju disks',
        'manipulations' => 'Manipulācijas',
        'custom_properties' => 'Pielāgotas īpašības',
        'generated_conversions' => 'Ģenerētas konversijas',
        'responsive_images' => 'Atsaucīgi attēli',
        'order_column' => 'Pasūtījuma kolonna',
        'migration' => 'Migrācija',
        'batch' => 'Partija',
        'permission_id' => 'Atļaujas id',
        'role_id' => 'Lomas id',
        'presenting_ability' => 'Prezentēšanas spēja',
        'capacity' => 'Ietilpība',
        'employee_using_possibility' => 'Darbinieka izmantošanas iespēja',
        'workplace_count' => 'Darbavietu skaits',
        'department_id' => 'Departamenta id',
        'token' => 'Marķieris',
        'guard_name' => 'Sargātāja vārds',
        'tokenable_type' => 'Marķējamo tipa',
        'tokenable_id' => 'Marķējamo id',
        'abilities' => 'Spējas',
        'last_used_at' => 'Pēdējo reizi izmantots',
        'expires_at' => 'Termiņš beidzas',
        'position_id' => 'Pozīcijas id',
        'email_verified_at' => 'Epasts verificēts',
        'phone_number' => 'Telefona numurs',
        'work_phone_number' => 'Darba telefona numurs',
        'remember_token' => 'Atcerēties marķieri',
        'purpose' => 'Mērķis',
        'starting_at' => 'Sākas',
        'ending_at' => 'Beidzas',
